...
void Open::initUniformBlockBuffer()
{
    // Get the index of the uniform block
    GLuint blockIndex = glGetUniformBlockIndex(gProgramHandle, "BlobSettings");
    
    // Allocate space for the buffer
    GLint blockSize;
    glGetActiveUniformBlockiv(gProgramHandle, blockIndex,
    ...
    GLuint indices[4];
    glGetUniformIndices(gProgramHandle, 4, names, indices);
    
    GLint offset[4];
    glGetActiveUniformsiv(gProgramHandle, 4, indices, GL_UNIFORM_OFFSET, offset);
