...
void Open::keyboard(unsigned char key, int x, int y)
{
	...
	{
		case 'x':
            rotMatrix=glm::rotate(glm::mat4(1.0f),1.0f,glm::vec3(1,0,0));
            orientationMatrix=orientationMatrix*rotMatrix;
            break;
		...
		case 'y':
            rotMatrix=glm::rotate(glm::mat4(1.0f),1.0f,glm::vec3(0,1,0));
            orientationMatrix=orientationMatrix*rotMatrix;
            break;
		...
		case 'z':
            rotMatrix=glm::rotate(glm::mat4(1.0f),1.0f,glm::vec3(0,0,1));
            orientationMatrix=orientationMatrix*rotMatrix;
            break;
